...
<div class="container">
        ...
        <div class="card bg-light">
            ...
            <div class="col-md-8">
                    <div  class="form-group row">
                            <label  for="loan_type" class="col-md-3 col-form-label text-md-right">{{ __('Head Line') }}</label>
        ...
        <div class="col-md-8">
            ...
            <div class="col-md-12">
                    <div class="form-group row">
                            <label for="detail" class="col-md-3 col-form-label text-md-right">{{ __('Detail') }}</label>
            ...
            <div class="col-md-6">
                    <div class="form-group row">
                            <label for="news_source" class="col-md-3 col-form-label text-md-right">{{ __('NEWS Source') }}</label>
            ...
            <div class="col-md-6">
                    <div class="form-group row">
                            <label for="news_provider" class="col-md-3 col-form-label text-md-right">{{ __('News Provider') }}</label>
            ...
            <div class="col-md-6">
                <div class="form-group row">
                        <label for="image_name" class="col-md-3 col-form-label text-md-right">{{ __('Image') }}</label>
