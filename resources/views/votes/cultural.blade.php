...
<body style="text-align: center;">
    ...
    <div class="container">
        ...
        <h2 style="color: #fafe00; text-transform:uppercase; margin-top:400px;">the result of Cabinate Secretary</h2>
    </div>
  ...
  <button onclick="window.location = '{{ URL::to('/information/secretary/vote/result')}}'" class="button" style="--hue: 80.17458568455291;">Get Next Result</button>
    ...
    <script>
        ...
        var config = {
            ...
            options: {
                ...
                title: {
                    display: true,
                    text: 'Cultural Secretary Vote Casting'
                },
                tooltips: {
                    mode: 'index',
                    intersect: false,
