...
<body style="text-align: center;">
    ...
    <div class="container">
        ...
        <h2 style="color: #fafe00; text-transform:uppercase; margin-top:400px;">the result of  president</h2>
    </div>
    ...
    <h2>First: <span style="color: red;"> {{$value->cname}} </span><small>Got: {{DB::table('votes')->where('votes.presidents',$value->presidents)->count() }} Votes</small> </h2>
    @endforeach

    <!-- <h2>Second: <span style="color: red;"> {{$second->cname}} </span><small>Got: {{DB::table('votes')->where('votes.presidents',73)->count() }} Votes</small> </h2> -->
