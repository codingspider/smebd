                ...
                <div class="block-content">
                    ...
                    <div class="single-post-box">
                        ...
                        <h1>{{$fashion_news_admins->headline}}</h1>
                            <ul class="post-tags">
                                <li><i class="fa fa-clock-o"></i>{{ date('d-m-Y', strtotime($fashion_news_admins->created_at))}}</li>
                                <li><i class="fa fa-user"></i>by <a href="#">{{$fashion_news_admins->news_provider}}</a></li>
                        ...
                        <div style="color:white" class="post-content">
                            ...
                            <p>{{$fashion_news_admins->short_description}}</p>
                           <br>
                           <p>{!! $fashion_news_admins->detail !!}</p>
