<?php namespace App\Http\Controllers;
	...
	class AdminSettings22Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Slogan','name'=>'slogan','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Ceo','name'=>'ceo','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:settings','width'=>'col-sm-10','placeholder'=>'Please enter a valid email address'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Slogan","name"=>"slogan","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			...
			//$this->form[] = ["label"=>"Ceo","name"=>"ceo","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|min:1|max:255|email|unique:settings","placeholder"=>"Please enter a valid email address"];
