<?php namespace App\Http\Controllers;
	...
	class AdminServicesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Service","name"=>"service"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Service','name'=>'service','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Service","name"=>"service","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
